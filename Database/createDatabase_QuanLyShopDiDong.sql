...
ALTER TABLE DONHANG ADD TenNguoiNhan varchar(50);
ALTER TABLE DONHANG ADD DiaChiNhan varchar(200);
ALTER TABLE DONHANG ADD SDT varchar(20);
ALTER TABLE DONHANG ADD GhiChu varchar(200);
ALTER TABLE KHACHHANG MODIFY MatKhau varchar(64);